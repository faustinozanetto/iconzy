...
const PARSED_COLOR_SCHEMES: ColorSchemes = {
  primary: {
    outline:
      'hover:bg-primary-300 hover:text-primary-800 focus:ring-primary-300',
    solid:
      'bg-primary-200 text-primary-800 hover:bg-primary-300 focus:ring-primary-300',
  },
  red: {
  ...
  orange: {
    ...
    solid:
      'bg-orange-200 text-orange-800 hover:bg-orange-300 focus:ring-orange-300',
  },
  yellow: {
    outline: 'hover:bg-yellow-300 hover:text-yellow-800 focus:ring-yellow-300',
    solid:
      'bg-yellow-200 text-yellow-800 hover:bg-yellow-300 focus:ring-yellow-300',
  },
  green: {
    outline: 'hover:bg-green-300 hover:text-green-800 focus:ring-green-300',
    solid:
      'bg-green-200 text-green-800 hover:bg-green-300 focus:ring-green-300',
  },
  teal: {
  ...
  indigo: {
    ...
    solid:
      'bg-indigo-200 text-indigo-800 hover:bg-indigo-300 focus:ring-indigo-300',
  },
  purple: {
    outline: 'hover:bg-purple-300 hover:text-purple-800 focus:ring-purple-300',
    solid:
      'bg-purple-200 text-purple-800 hover:bg-purple-300 focus:ring-purple-300',
  },
};
  ...
  (props, ref) => {
    ...
    const getButtonVariants = (): string => {
      return variant === 'solid'
        ? PARSED_COLOR_SCHEMES[colorScheme].solid
        : PARSED_COLOR_SCHEMES[colorScheme].outline;
    };
    ...
    return (
      ...
      >
        {leftIcon && (
          <div className='inline-flex shrink-0 self-center pr-1'>
            {leftIcon}
          </div>
        )}
        {children}
        {rightIcon && (
          <div className='inline-flex shrink-0 self-center pl-1'>
            {rightIcon}
          </div>
        )}
      </button>
