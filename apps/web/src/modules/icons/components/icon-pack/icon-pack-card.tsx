...
const IconPackCard: React.FC<IconPackCardProps> = (props) => {
  ...
  return (
    <div
      ...
      className="overflow-hidden rounded-lg justify-center flex items-center flex-col p-4 space-y-2 bg-neutral-50 border-neutral-300 border-[1px] dark:bg-neutral-800 dark:border-neutral-700 hover:scale-105 transition-transform w-[250px]"
    >
