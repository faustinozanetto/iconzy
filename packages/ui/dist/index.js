...
var IconButton = React2.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "inline-flex self-center", children: icon })
    })
  );
});
...
var Separator = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("hr", __spreadValues({ className: "mt-2 h-[1px] border-none bg-neutral-200 dark:bg-neutral-700" }, rest));
};
...
var ToastsContainer = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "fixed z-50 flex flex-col bottom-0 right-0 left-0 pointer-events-none", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "max-w-xl mx-auto", children: state.toasts && state.toasts.map((toast) => {
