...
var RangeInput = React6.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsx7(InputWrapper, {
    id,
    label,
    onInputReseted: () => {
...
var ColorInput = React7.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsx8(InputWrapper, {
    id,
    label,
    onInputReseted: () => {
...
export { Button, Card, ColorInput, RangeInput, SelectInput, Separator, TextInput, defaultColors };
