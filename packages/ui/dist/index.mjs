...
var Toast2 = (props) => {
  ...
  return /* @__PURE__ */ jsx11(motion.div, { layout: true, className: "flex flex-col items-center m-2", children: /* @__PURE__ */ jsxs8(
    "div",
    {
      className: clsx4(
...
var ToastsContainer = () => {
  ...
  return /* @__PURE__ */ jsx12("div", { className: "fixed z-50 flex flex-col bottom-0 right-0 left-0 pointer-events-none", children: /* @__PURE__ */ jsx12("div", { className: "max-w-xl mx-auto", children: /* @__PURE__ */ jsx12(AnimatePresence, { children: state.toasts && state.toasts.map((toast) => {
